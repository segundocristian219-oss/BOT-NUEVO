  ...
  for (const name in global.plugins) {
    ...
    if (plugin.before) {
      const stop = await plugin.before.call(this,m,{
        match,conn:this,participants,groupMetadata,userGroup,botGroup,isROwner,isOwner,isRAdmin,isAdmin,isBotAdmin,isPrems,chatUpdate,__dirname:___dirname,__filename,user,chat,settings
      })
      if (stop) continue
    }
    ...
    const accept = plugin.command instanceof RegExp?plugin.command.test(command):
